# WeesyOS in Rust 🦀 (Unsafe) -- Archived
...
> [!NOTE]
> This branch is currently undergoing restructuring to more closely follow the assignment's purpose. You can still boot it. For any issues, please reach out via <a href="mailto:anton.melnychuk@yale.edu">anton.melnychuk@yale.edu</a>.
